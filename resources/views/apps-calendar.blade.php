...
<link href="{{ URL::asset('/public/assets/css/main.css') }}" rel="stylesheet" type="text/css" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-lg-12 col-sm-6">
                                <img src="public/assets/images/undraw-calendar.svg" alt="" class="img-fluid d-block">
                            </div>
                        </div>
...
<!-- Calendar init -->
<script src="{{ URL::asset('/public/assets/js/pages/calendar.init.js') }}"></script>
