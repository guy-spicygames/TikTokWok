...
@section('css')
    <!-- owl.carousel css -->
    <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/owl.carousel/owl.carousel.min.css') }}">
@endsection
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ URL::asset('/public/assets/images/logo-sm.svg') }}" alt="" height="28">
                                            ...
                                            <div class="carousel-inner">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ URL::asset('/public/assets/images/users/avatar-1.jpg') }}"
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ URL::asset('/public/assets/images/users/avatar-2.jpg') }}"
                                                                        class="avatar-md img-fluid rounded-circle"
                                                                        alt="...">
                                                                </div>
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <img src="{{ URL::asset('/public/assets/images/users/avatar-3.jpg') }}"
