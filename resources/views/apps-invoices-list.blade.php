...
@section('css')
    ...
    <!-- flatpickr css -->
    <link href="{{ URL::asset('/public/assets/libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css">
...
@section('script')
    ...
    <!-- init js -->
    <script src="{{ URL::asset('/public/assets/js/pages/invoices-list.init.js') }}"></script>
