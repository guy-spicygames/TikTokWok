...
@section('script')
    <!-- jquery-sparkline js -->
    <script src="{{ URL::asset('/public/assets/libs/jquery-sparkline/jquery-sparkline.min.js') }}"></script>
    <!-- sparkline init -->
    <script src="{{ URL::asset('/public/assets/js/pages/sparklines.init.js') }}"></script>
