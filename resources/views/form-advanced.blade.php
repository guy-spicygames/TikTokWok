...
@section('css')
    ...
    <!-- choices css -->
    <link href="{{ URL::asset('/public/assets/libs/choice-js/choice-js.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- color picker css -->
    <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/@simonwep/@simonwep.min.css') }}" />
    <!-- 'classic' theme -->
    {{-- <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/@simonwep/pickr/themes/monolith.min.css') }}" />
    <!-- 'monolith' theme -->
    <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/@simonwep/pickr/themes/nano.min.css') }}" /> --}}
    <!-- 'nano' theme -->

    <!-- datepicker css -->
    <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/flatpickr/flatpickr.min.css') }}">
...
@section('script')
    ...
    <!-- choices js -->
    <script src="{{ URL::asset('/public/assets/libs/choice-js/choice-js.min.js') }}"></script>

    <!-- color picker js -->
    {{-- <script src="{{ URL::asset('/public/assets/libs/@simonwep/pickr/pickr.min.js') }}"></script> --}}
    <script src="{{ URL::asset('/public/assets/libs/@simonwep/@simonwep.min.js') }}"></script>
