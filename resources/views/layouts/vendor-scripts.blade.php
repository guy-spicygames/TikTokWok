...
<script src="{{ URL::asset('public/assets/libs/feather-icons/feather-icons.min.js') }}"></script>
<!-- pace js -->
<script src="{{ URL::asset('public/assets/libs/pace-js/pace-js.min.js') }}"></script>
@yield('script')
