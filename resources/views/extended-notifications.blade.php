...
@section('css')
    ...
    <!-- alertifyjs Css -->
    <link href="{{ URL::asset('/public/assets/libs/alertifyjs/alertifyjs.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- alertifyjs default themes  Css -->
    {{-- <link href="{{ URL::asset('/public/assets/libs/alertifyjs/build/css/themes/default.min.css') }}" rel="stylesheet"
        type="text/css" /> --}}
                            ...
                            <div class="p-2">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive" data-bs-autohide="false"
                                    ...
                                    <div class="toast-header">
                                        <img src="public/assets/images/logo-sm.svg" alt="" class="me-2" height="18">
...
@section('script')
    ...
    <script src="{{ URL::asset('/public/assets/libs/alertifyjs/alertifyjs.min.js') }}"></script>

    <script src="{{ URL::asset('/public/assets/js/pages/notification.init.js') }}"></script>
