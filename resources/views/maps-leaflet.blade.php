...
@section('css')
    ...
    <!-- leaflet Css -->
    <link href="{{ URL::asset('/public/assets/libs/leaflet/leaflet.min.css') }}" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <!-- leaflet plugin -->
    <script src="{{ URL::asset('/public/assets/libs/leaflet/leaflet.min.js') }}"></script>

    <!-- leaflet map.init -->
    <script src="{{ URL::asset('/public/assets/js/pages/leaflet-us-states.js') }}"></script>
    <script src="{{ URL::asset('/public/assets/js/pages/leaflet-map.init.js') }}"></script>
