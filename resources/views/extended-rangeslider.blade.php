...
@section('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('/public/assets/libs/nouislider/nouislider.min.css') }}">
...
@section('script')
    ...
    <!-- nouisliderribute js -->
    <script src="{{ URL::asset('/public/assets/libs/nouislider/nouislider.min.js') }}"></script>
    <script src="{{ URL::asset('/public/assets/libs/wnumb/wnumb.min.js') }}"></script>

    <!-- range slider init -->
    <script src="{{ URL::asset('/public/assets/js/pages/rangeslider.init.js') }}"></script>
