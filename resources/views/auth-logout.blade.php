...
@section('body')
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="public/assets/images/logo-sm.svg" alt="" height="28"> <span
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-2">
                                                ...
                                                <p class="text-muted font-size-15">Thank you for using <span
                                                        class="fw-semibold text-dark">Minia</span></p>
                                                <div class="mt-4">
                                                    <a href="auth-login"
    ...
    @endsection
    @section('script')
        <script src="{{ URL::asset('public/assets/js/pages/pass-addon.init.js') }}"></script>
    @endsection
