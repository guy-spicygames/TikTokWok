...
@section('css')
    ...
    <link rel="stylesheet"
        href="{{ URL::asset('/public/assets/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.css') }}">
...
@section('script')
    ...
    <script src="{{ URL::asset('/public/assets/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.js') }}"></script>
    {{-- <script src="{{ URL::asset('/public/assets/libs/twitter-bootstrap-wizard/prettify.js') }}"></script> --}}

    <!-- form wizard init -->
    <script src="{{ URL::asset('/public/assets/js/pages/form-wizard.init.js') }}"></script>
