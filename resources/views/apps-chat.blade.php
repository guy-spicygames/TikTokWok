            ...
            <div class="p-3 px-4 border-bottom">
                <div class="d-flex align-items-start ">
                    <div class="flex-shrink-0 me-3 align-self-center">
                        <img src="public/assets/images/users/avatar-1.jpg" class="avatar-sm rounded-circle" alt="">
                    </div>
                                        ...
                                        <ul class="list-inline message-img mt-3  mb-0">
                                            <li class="list-inline-item message-img-list">
                                                <a class="d-inline-block m-1" href="">
                                                    <img src="public/assets/images/small/img-1.jpg" alt=""
                                            ...
                                            <li class="list-inline-item message-img-list">
                                                <a class="d-inline-block m-1" href="">
                                                    <img src="public/assets/images/small/img-2.jpg" alt=""
                                                        class="rounded img-thumbnail">
                                                </a>
                                            </li>
                                        </ul>
