...
@section('css')
    ...
    <link href="{{ URL::asset('/public/assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}"
        rel="stylesheet" type="text/css" /> --}}
...
@section('script')
    ...
    {{-- <script src="{{ URL::asset('/public/assets/libs/pdfmake/vfs_fonts.js') }}"></script> --}}
    ...
    <script src="{{ URL::asset('/public/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}">
    </script> --}}
